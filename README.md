...
This setup works with [tox](https://github.com/tox-dev/tox) project as an example, cloned in the parent folder (**../tox** relative to this project), but it can be a template setup for any other project using **tox** as automation tool for **CI** or to run tests and generate **development environments**.
